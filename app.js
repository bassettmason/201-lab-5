...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var sMessage3 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum3 + '.';
  var pMessage3 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product3 + '.';
  
    return [sum3, product3, sMessage3, pMessage3];
...
function sumArray (testArray) {
  var sumArray4 = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var message4 = testArray[0] + ','  + testArray[1] + ',' + testArray[2]  + ' was passed in as an array of numbers, and ' + sumArray4 + ' is their sum.';
      return [sumArray4, message4];
}
...
function multiplyArray (testArray) {
  var productArray5 = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  var message5 = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of 24.'
    
  return [productArray5, message5];
}
